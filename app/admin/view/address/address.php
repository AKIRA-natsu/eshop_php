...
<div class="container">
    ...
    <h4>一共能添加10条地址，你已经添加{$count}条地址，<a href="{:url('address/to_address_edit')}" style="color: black">点击此处添加地址</a></h4>
    <div class="row">
            ...
            <div class="panel panel-default">
                <div>
                    <div class="panel-body">
                        ...
                        <div class="col-md-2" >
                            <a href="{:url('address/to_address_update?address_id='.$list.address_id)}">修改</a>
                            <a href="{:url('address/delete_address?address_id='.$list.address_id.'&status='.$list.status)}">删除</a>
                            <a href="{:url('address/update_status?address_id='.$list.address_id)}">设为默认</a>
                        </div>
                    </div>
